...
class TrainingCallbacks(DefaultCallbacks):
    ...
    def on_episode_end(self, worker, base_env, policies, episode, **kwargs):
        ...
        # cooking_stats = ep_info["ep_cooking_stats"]

        # List of episode stats we'd like to collect by agent
        stats_to_collect = [
            "onion_pickup", "useful_onion_pickup", "onion_drop", "useful_onion_drop", "potting_onion",
            "dish_pickup", "useful_dish_pickup", "dish_drop", "useful_dish_drop", "soup_pickup", "soup_delivery",
